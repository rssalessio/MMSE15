...
class NewAccount(ttk.Frame):
    ...
    def create_widgets(self):
        ttk.Label(self, text="Username:").grid(row=0, sticky="E")
        self.e1 = ttk.Entry(self)
        self.e1.grid(row=0, column=1, sticky="W")

        b1 = ttk.Button(self, text="Create",
                        command=lambda: self.ctrl.new_account_create(self))
    ...
    class Form(ttk.Frame):
        ...
        def already_exist(self):
            ...
            ttk.Label(self, text="Username already used!").grid()
        ...
        def create_widgets(self):
            ...
            self.e2 = self.master.e1.get()  # Username
