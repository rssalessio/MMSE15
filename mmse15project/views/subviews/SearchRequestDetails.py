    ...
    class SearchResult(ttk.Frame):
        ...
        def create_widgets(self):
            ...
            if request_details is False:
                ...
                self.e1.insert(tk.INSERT, data[1])
                self.e2.insert(tk.INSERT, data[2])
                self.e3.insert(tk.INSERT, data[3])
                self.e4.insert(tk.INSERT, data[4])
                self.e5.insert(tk.INSERT, data[5])
                self.e6.insert(tk.INSERT, data[6])
                self.e7.insert(tk.INSERT, data[7])
